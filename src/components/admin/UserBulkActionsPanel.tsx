...
import { CheckCircle, Ban, Shield, X, Crown, Loader2 } from 'lucide-react';
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {unblockedCount > 0 && (
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    <AlertDialogTitle>Bloquear Usuários em Lote</AlertDialogTitle>
                    <AlertDialogDescription>
                      Você está prestes a bloquear {unblockedCount} usuário{unblockedCount > 1 ? 's' : ''}. 
                      Os usuários bloqueados não poderão acessar a plataforma e suas assinaturas serão suspensas.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
            ...
            {blockedCount > 0 && (
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    <AlertDialogTitle>Desbloquear Usuários em Lote</AlertDialogTitle>
                    <AlertDialogDescription>
                      Você está prestes a desbloquear {blockedCount} usuário{blockedCount > 1 ? 's' : ''}. 
                      Os usuários poderão acessar a plataforma novamente e suas assinaturas serão reativadas.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
                    <AlertDialogCancel>Cancelar</AlertDialogCancel>
